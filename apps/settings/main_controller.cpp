...
constexpr Shared::SettingsMessageTree s_modelAngleChildren[3] = {Shared::SettingsMessageTree(I18n::Message::Degrees), Shared::SettingsMessageTree(I18n::Message::Radian), Shared::SettingsMessageTree(I18n::Message::Gradians)};
constexpr Shared::SettingsMessageTree s_modelEditionModeChildren[2] = {Shared::SettingsMessageTree(I18n::Message::Edition2D), Shared::SettingsMessageTree(I18n::Message::EditionLinear)};
constexpr Shared::SettingsMessageTree s_modelFloatDisplayModeChildren[4] = {Shared::SettingsMessageTree(I18n::Message::Decimal), Shared::SettingsMessageTree(I18n::Message::Scientific), Shared::SettingsMessageTree(I18n::Message::Engineering), Shared::SettingsMessageTree(I18n::Message::SignificantFigures)};
constexpr Shared::SettingsMessageTree s_modelComplexFormatChildren[3] = {Shared::SettingsMessageTree(I18n::Message::Real), Shared::SettingsMessageTree(I18n::Message::Cartesian), Shared::SettingsMessageTree(I18n::Message::Polar)};
constexpr Shared::SettingsMessageTree s_modelFontChildren[2] = {Shared::SettingsMessageTree(I18n::Message::LargeFont), Shared::SettingsMessageTree(I18n::Message::SmallFont)};
constexpr Shared::SettingsMessageTree s_modelAboutChildren[3] = {Shared::SettingsMessageTree(I18n::Message::SoftwareVersion), Shared::SettingsMessageTree(I18n::Message::SerialNumber), Shared::SettingsMessageTree(I18n::Message::FccId)};
...
const Shared::SettingsMessageTree * MainController::model() {
  return &s_model;
}
