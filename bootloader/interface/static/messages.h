...
public:
  ...
  constexpr static const char * aboutMessage2 = "the Numworks Calculator.";
  ...
  //USB NAMES
  constexpr static const char * usbUpsilonBootloader = "Numworks Bootloader";
  constexpr static const char * usbUpsilonRecovery = "Numworks Recovery";
