...
PLS_IGNORE := $(shell >&2 printf "\n\e[91m\e[1mDISCLAIMER:\n")
PLS_IGNORE := $(shell >&2 printf "\e[91m\e[1mThis is illegal to use this repo. I made this only for challenge and that's all!\n")
PLS_IGNORE := $(shell >&2 printf "\e[91m\e[1mI can't be held responsible for any resulting damage and causes that may result.\n")
PLS_IGNORE := $(shell >&2 printf "\e[91m\e[1mI decline all responsibility for this repo, which is why it is marked as archived.\n")
